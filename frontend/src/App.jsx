...
export default function App() {
  ...
  const sampleRequests = [
    ...
    { id: 7, title: 'Vendor Risk Tiering Matrix', status: 'done', priority: 'high', assigned_to: 'eric', created_by: 'demo', created_at: '2025-05-15', description: 'Complete risk tiering for all active suppliers based on product category and volume.', comments: [{ id: 1, author: 'eric', text: 'Completed for all Tier 1 suppliers', created_at: '2025-05-28' }], files: [] },
    { id: 8, title: 'ISO 9001 Cert Verification – APAC Suppliers', status: 'in_progress', priority: 'medium', assigned_to: 'lyes', created_by: 'nancy', created_at: '2025-06-03', description: 'Verify ISO 9001 certificates cover specific manufacturing facilities, not just HQ.', comments: [], files: [] },
    { id: 9, title: 'Annual Re-Audit Schedule 2025', status: 'open', priority: 'medium', assigned_to: 'demo', created_by: 'wilson', created_at: '2025-06-11', description: 'Build schedule for annual factory re-audits. Prioritize suppliers with prior non-conformances.', comments: [], files: [] },
    { id: 10, title: 'Shipment Hold Log – Q2 2025', status: 'done', priority: 'high', assigned_to: 'wilson', created_by: 'nancy', created_at: '2025-04-30', description: 'Extract all shipment holds triggered by failed PSI or lab tests in Q2.', comments: [{ id: 2, author: 'wilson', text: 'Exported from SAP. 14 holds total.', created_at: '2025-05-10' }, { id: 3, author: 'nancy', text: 'Can you break down by supplier?', created_at: '2025-05-11' }], files: [] },
    { id: 11, title: 'APQP Control Plan Gap Analysis', status: 'in_progress', priority: 'high', assigned_to: 'eric', created_by: 'demo', created_at: '2025-06-02', description: 'Identify gaps between APQP control plans and actual production testing protocols.', comments: [], files: [] },
    { id: 12, title: 'Approved Auditor List – Current', status: 'done', priority: 'low', assigned_to: 'demo', created_by: 'nancy', created_at: '2025-05-25', description: 'Obtain current approved FQA auditor list with qualification dates and scope.', comments: [{ id: 4, author: 'demo', text: 'List received from QA team, 23 auditors total.', created_at: '2025-05-27' }], files: [] },
    { id: 13, title: 'Multi-Geo Production Authorization Docs', status: 'open', priority: 'high', assigned_to: 'marcia', created_by: 'lyes', created_at: '2025-06-14', description: 'Collect production authorization documents for products manufactured across multiple geographies.', comments: [], files: [] },
    { id: 14, title: 'Design FMEA Records – CPB Products', status: 'blocked', priority: 'medium', assigned_to: 'marc', created_by: 'eric', created_at: '2025-06-09', description: 'Retrieve Design FMEA documentation for all CPB product lines. Blocked on access permissions.', comments: [{ id: 5, author: 'marc', text: 'Waiting on PLM system access from IT', created_at: '2025-06-10' }], files: [] },
    { id: 15, title: 'Supplier Financial Statements – Overdue', status: 'in_progress', priority: 'high', assigned_to: 'demo', created_by: 'nancy', created_at: '2025-06-07', description: 'Identify suppliers with financial statements older than 12 months and request updated versions.', comments: [], files: [] },
    { id: 16, title: 'Lab Audit Frequency Report', status: 'open', priority: 'medium', assigned_to: 'nancy', created_by: 'demo', created_at: '2025-06-15', description: 'Report on audit frequency and coverage for all approved third-party testing labs.', comments: [], files: [] },
    { id: 17, title: 'IPC Checkpoint Documentation', status: 'done', priority: 'medium', assigned_to: 'wilson', created_by: 'eric', created_at: '2025-05-18', description: 'Collect in-process control checkpoint records for active production lines.', comments: [{ id: 6, author: 'wilson', text: 'All 8 production lines documented', created_at: '2025-06-01' }], files: [] },
    { id: 18, title: 'Exception Handling Procedures – Compliance', status: 'open', priority: 'low', assigned_to: 'lyes', created_by: 'marcia', created_at: '2025-06-13', description: 'Document exception handling procedures for multi-geography compliance deviations.', comments: [], files: [] },
  ];
