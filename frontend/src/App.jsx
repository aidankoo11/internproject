...
export default function App() {
  ...
  const sampleRequests = [
    ...
    { id: 2, title: 'Supplier Onboarding Checklist Data', status: 'open', priority: 'medium', assigned_to: 'demo', assignee: 'Aidan Koo', created_by: 'eric', created_at: '2025-06-05', description: 'APQP pre-qualification documentation for new vendor onboarding process.', comments: [], files: [] },
    ...
    { id: 9, title: 'Annual Re-Audit Schedule 2025', status: 'open', priority: 'medium', assigned_to: 'demo', assignee: 'Aidan Koo', created_by: 'wilson', created_at: '2025-06-11', description: 'Build schedule for annual factory re-audits. Prioritize suppliers with prior non-conformances.', comments: [], files: [] },
    ...
    { id: 12, title: 'Approved Auditor List – Current', status: 'done', priority: 'low', assigned_to: 'demo', assignee: 'Aidan Koo', created_by: 'nancy', created_at: '2025-05-25', description: 'Obtain current approved FQA auditor list with qualification dates and scope.', comments: [{ id: 4, author: 'demo', text: 'List received from QA team, 23 auditors total.', created_at: '2025-05-27' }], files: [] },
    ...
    { id: 15, title: 'Supplier Financial Statements – Overdue', status: 'in_progress', priority: 'high', assigned_to: 'demo', assignee: 'Aidan Koo', created_by: 'nancy', created_at: '2025-06-07', description: 'Identify suppliers with financial statements older than 12 months and request updated versions.', comments: [], files: [] },
