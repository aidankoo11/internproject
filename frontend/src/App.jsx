...
export default function App() {
  ...
  const sampleRequests = [
    ...
    { id: 2, title: 'Supplier Onboarding Checklist Data', status: 'open', priority: 'medium', assigned_to: 'demo', assignee: 'demo', created_by: 'eric', created_at: '2025-06-05', target_date: '2025-06-25', description: 'APQP pre-qualification documentation for new vendor onboarding process.', comments: [], files: [] },
    ...
    { id: 9, title: 'Annual Re-Audit Schedule 2025', status: 'open', priority: 'medium', assigned_to: 'demo', assignee: 'demo', created_by: 'wilson', created_at: '2025-06-11', target_date: '2025-06-22', description: 'Build schedule for annual factory re-audits. Prioritize suppliers with prior non-conformances.', comments: [], files: [] },
